...
four = CalendarFourier(freq="YS", order=10)
...
dp = DeterministicProcess(
    ...
    order=1,
    seasonal=True,
    additional_terms=[four], # the time dummy (trend)
...
ax = df.plot(y=df.columns[1],  title="Tunnel Traffic - Linear Trend")
